...
1. **[PROBLEMA_RESUELTO.md](./PROBLEMA_RESUELTO.md)** - Problemas Comunes y Soluciones
   - Errores frecuentes
   - Soluciones probadas
   - Tips de debugging

2. **[SOLUCION_DEPLOYMENT.md](./SOLUCION_DEPLOYMENT.md)** ⭐ - Errores de Deployment
   - Error de postinstall
   - Problemas de conexión a base de datos
   - Errores de permisos
   - Variables de entorno
   - **Ideal para:** Resolver errores durante el deploy

3. **[UPDATE_SUMMARY.md](./UPDATE_SUMMARY.md)** - Resumen de Actualizaciones
   - Cambios recientes
...
### 1. ❌ Error: "Cannot find module 'create-admin'"

**Causa:** Script postinstall intenta ejecutarse durante npm install

**Solución:**
```bash
# 1. Usar package.production.json en lugar de package.json
mv package.json package.backup.json
cp package.production.json package.json

# 2. Instalar dependencias SIN postinstall
npm install --production

# 3. Crear admin DESPUÉS de la instalación
npm run create-admin
```

📖 **Ver más:** [SOLUCION_DEPLOYMENT.md](./SOLUCION_DEPLOYMENT.md)
